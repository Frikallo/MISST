...
begin
  ...
  begin
    ...
    begin
      DownloadURL := 'https://github.com/Frikallo/MISST/releases/download/V3.0.9/MISST_CUDA_3.0.9_Release_Win.7z';
      DownloadFileName := 'MISST.7z';
    end
    else
    begin
      DownloadURL := 'https://github.com/Frikallo/MISST/releases/download/V3.0.9/MISST_CPU_3.0.9_Release_Win.7z';
      DownloadFileName := 'MISST.7z';
    end;
