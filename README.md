...
These instructions are for those installing MISST v2.0.5 **manually** only.
...
2. Download the Source code [here](https://github.com/Frikallo/MISST/archive/refs/tags/v2.0.5.zip)
