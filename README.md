...
## Installation
as of version 2.0.1, MISST is not available for any platform with guaranteed compatibility. Until a later version, please refer to [Manual Installation](https://github.com/Frikallo/MISST/#manual-installation-for-developers) .
...
These instructions are for those installing MISST v2.0.1 **manually** only.
...
2. Download the Source code [here](https://github.com/Frikallo/MISST/archive/refs/tags/v2.0.1.zip)
